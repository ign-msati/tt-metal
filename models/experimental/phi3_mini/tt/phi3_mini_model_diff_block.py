...
class TtPhi3MiniModel(LightweightModule):
    ...
    def __init__(self, config, state_dict, device,LAYER_INDEX_SPLIT, vocab_size=51200, 
        ...
        self.n_layer = LAYER_INDEX_SPLIT
        #####################################
    ...
    def forward(
        ...
        # x = ttnn.layer_norm(x, epsilon=1e-05, weight=self.final_layernorm_weights)
